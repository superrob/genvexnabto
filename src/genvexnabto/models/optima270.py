...
class GenvexNabtoOptima270(GenvexNabtoBaseModel):
    def __init__(self, slaveDeviceModel):
        ...
        self._datapoints = {
            ...
            GenvexNabtoDatapointKey.ALARM_OPTIMA270_1: GenvexNabtoDatapoint(address=114),
            GenvexNabtoDatapointKey.ALARM_OPTIMA270_2: GenvexNabtoDatapoint(address=115),
        ...
        self._setpoints = {
            ...
            GenvexNabtoSetpointKey.BYPASS_TURNOFF: GenvexNabtoSetpoint(read_address=29, write_address=68, min=0, max=20),
            GenvexNabtoSetpointKey.BYPASS_FORCE_SPEED: GenvexNabtoSetpoint(read_address=57, write_address=124, min=0, max=100),
            GenvexNabtoSetpointKey.BYPASS_FORCE_TEMP: GenvexNabtoSetpoint(read_address=58, write_address=126, divider=10, min=0, max=50, step=0.1),
            #GenvexNabtoSetpointKey.BYPASS_MIN_ON: GenvexNabtoSetpoint(read_address=59, write_address=128, min=0, max=60), // Seems locked down
    ...
    def getDefaultDatapointRequest(self) -> List[GenvexNabtoDatapointKey]:
        return [
            ...
            GenvexNabtoDatapointKey.ALARM_OPTIMA270_1,
            GenvexNabtoDatapointKey.ALARM_OPTIMA270_2,
    ...
    def getDefaultSetpointRequest(self) -> List[GenvexNabtoSetpointKey]:
        return [
            ...
            GenvexNabtoSetpointKey.BYPASS_FORCE_SPEED,
            GenvexNabtoSetpointKey.BYPASS_FORCE_TEMP,
            #GenvexNabtoSetpointKey.BYPASS_MIN_ON,
